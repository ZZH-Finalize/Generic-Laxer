...
namespace regex {
    ...
    concept fa_final_state = std::is_convertible_v<T, typename U::id_t>
                             and std::is_constructible_v<T, typename U::id_t>
                             and std::is_assignable_v<T&, typename U::id_t>;

    template<typename final_state_t>
    requires fa_final_state<final_state_t, __nfa_state>
    ...
    using nfa = basic_nfa<__nfa_state::id_t>;
