...
int main(const int argc, const char** argv)
{
    ...
    try {
        ...
        std::cout << "\n--- 测试4: 字符集 ---" << std::endl;
        {
            regex::dfa dfa("a[0-9]c");  // a后跟一个数字再跟c
        ...
        std::cout << "\n--- 测试5: 否定字符集 ---" << std::endl;
        {
            regex::dfa dfa("a[^0-9]c");  // a后跟一个非数字再跟c
        ...
        std::cout << "\n--- 测试7: 量词+ ---" << std::endl;
        {
            regex::dfa dfa("ab+c");  // a后跟一个或多个b，然后是c
        ...
        std::cout << "\n--- 测试8: 量词? ---" << std::endl;
        {
            regex::dfa dfa("ab?c");  // a后跟零个或一个b，然后是c
            print_match(dfa, "ac", "ab?c匹配ac", true);     // 零个b
            print_match(dfa, "abc", "ab?c匹配abc", true);    // 一个b
        ...
        {
            regex::dfa dfa("(cat|dog)s?");  // cat或dog，后跟可选的s
        ...
        {
            regex::dfa dfa("[a-z].[0-9]");  // 小写字母 + 任意字符 + 数字
